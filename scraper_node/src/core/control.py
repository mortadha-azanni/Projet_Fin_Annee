...
SCRAPER_CONTROL_STATE_KEY = "scraper_control_state"
SCRAPER_TASK_ID_KEY = "current_scraper_task_id"
SCRAPER_PROGRESS_CHANNEL = "scraper_progress"
...
def check_scraper_state():
    ...
    """
    while True:
        state = redis_client.get(SCRAPER_CONTROL_STATE_KEY) or "running"
        if state == "stopped":
